...
networks['feat_model'] = {'def_file': './models/ResNet10Feature_freeze.py',
...
memory['update'] = 2    # 0 for update_prototypes, 1 for update_prototypes_new, 2 for use PrototypeUpdateLoss, 3 for update_prototypes_mopro
